...
#ArkOS
    ...
    sudo nice --19 alsaloop -P plughw:${USBDEV},0 -C hw:M8,0 -t 200000 -A 5 --rate 44100 --sync=1 -T -1 -d
    sleep 1
    ./_m8c/m8c
    sudo pkill alsaloop
else
#ROCKNIX
    ...
    pactl load-module module-loopback source=${M8} sink=${USBDEV} latency_msec=200 format=s16le rate=44100 channels=2
    sleep 2
