...
#ROCKNIX
    ...
    pactl load-module module-loopback source=${M8OUT} sink=${SPK} latency_msec=200 format=s16le rate=44100 channels=2
    sleep 2
    pactl load-module module-loopback source=${USBDEV} sink=${M8IN} latency_msec=200 format=s16le rate=44100 channels=2
    sleep 2
    ./_m8c/m8c
